...
export interface VerifyEmailScreenProps {
  onInitVerification: () => Promise<void>;
  onVerify: (code: string) => Promise<{ accessToken: string }>;
  onComplete: (accessToken: string) => void;
}

export function VerifyEmailScreen({ onInitVerification, onVerify, onComplete }: VerifyEmailScreenProps) {
  ...
  const handleResend = async () => {
    ...
    toast.promise(onInitVerification, {
